...
%%% Deklarace hlavičky dokumentu. Pokud není potřeba oboustranný dokument,
%%% je možné zrušit argument `twoside'. Argument by měl být vypnut pouze
...
%%%
%%% Je-li použit argument `noseceqn', rovnice budou číslovány v rámci celého
%%% dokumentu. Implicitně jsou rovnice číslovány v rámci kapitol.
%%%
...
%%% řádek v názvu dokumentu -- ten není nikdy vypisován versálkami.
\title{Název textu}
